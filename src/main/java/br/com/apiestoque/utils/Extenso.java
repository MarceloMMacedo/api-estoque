package br.com.apiestoque.utils;
...
public class Extenso {
	...
	public String toString() {
		...
		Object[] objs = new Object[1];
		objs[0] = valorMonetario;
		formatter.format("%-,3.2f", objs);

		// retorna o número informado no formato de valor monetário,
		// International Locale Default.
		String s1=formatter.toString();
		String s= sym.getCurrencySymbol() + " " + s1;
		s+="("+ buf.toString()+")";
		return s;
	}
	...
	/**
	 * <p>
	 * Identifica se a quantidade de dígitos do primeiro grupo do valor for igual a
	 * uma unidade.
	 * </p>
	 *
	 ...
	 *         conter um valor maior que 1. <code><b>false</b></code> se a posição
	 *         do dígito no número conter um valor igual a zero.
	 * @since JDK 1.5
	 */
	 ...
	 * restando apenas a casa centezimal (dos centavos) a ser convertida por
	 * extenso.
	 * </p>
	 * <p>
	 * Obs.: Grupos são também conhecidos por casas, assim como, casas decimais,
	...
	/**
	 * <p>
	 * Converte um número em uma String para identificar o posicionamento de seus
	 * dígitos.
	 * </p>
	 *
	 * @param numero
