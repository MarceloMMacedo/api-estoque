...
public interface ReportService {
	 ...
	 * @return the String containing the HTML
	 */
	String generateHtmlReport(String inputFileName, Map<String, Object> params, List<?>  dataSource);
	 ...
	 * @param params        report parameters
	 * @param dataSource    the source of data
	 * @return the List containing the HTML and a Map populated with inline
	 *         source(s)
	 */
	List<Object> generateInlineHtmlReport(String inputFileName, Map<String, Object> params, List<?>  jRDataSource);
}
